...
function FormValidWithPassword() {
  //1.hook Area
  ...
  let handleKeyUp = (e)=>{
      ...
      let passwordformat =  /^[A-Za-z]\w{7,14}$/;
        ...
        if((fname.value) !== ""){
            ...
            //     ps.innerHTML = "";
            // }else{    
            //     ps.innerHTML = "Please Enter aphabets, Numberss, Special Charactors";   
            // }
        }else{
    ...
    // var 
                    ...
                    // else
                    // { 
                    //     console.log("asdjhasdxahxgZx")
                    //     ps.innerText == "Please Enter aphabets, Numberss, Special Charactors";
                    //     return false;
                    //     console.log("jawsdh")
                    // }
...
export default FormValidWithPassword;
